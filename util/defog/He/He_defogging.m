function [L,t_initial,t,R] = He_defogging(I)
...
% check input
assert(isa(I,'double'),'The input hazy image has to be of type double')
...
% L = estimate_atmospheric_light_dcp(I_dark, I);      % original method
L = estimate_atmospheric_light_rf(I_dark, I);       % refined method
